...
for i = 1:length(component_list_tmp(:,1))
    component_list = [component_list ; [component_list_tmp(i,1), component_list_tmp(i,2)]];
    component_list = [component_list ; [component_list_tmp(i,2), component_list_tmp(i,1)]];
end
...
for l = 1:length(noise_list)
    ...
    for i = 1:num_data
        ...
        for j = 1:length(component_list(:,1))
            ...
            [score_list, t_1, t_2] = RDS_dim1(y_target(:,st), y_target(:,ed), t, time_interval);
    ...
    %filename = ['IFL_result_dim1_',num2str(noise_percent)];
    filename = ['CFL_result_dim1_',num2str(noise_percent)];
    %filename = ['SFL_result_dim1_',num2str(noise_percent)];
