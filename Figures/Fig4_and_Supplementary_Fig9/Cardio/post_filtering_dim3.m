...
%% calculate delta
delta_list = zeros(num_candidate_delta, 3);
cor_type = [
    [2,3,5];
    [1,4,6];
    [4,1,7];
...
%for i = 6
    ...
    idx = intersect(intersect(idx_st1, idx_st2),idx_st3);
...
%         score_list = zeros(length(t_1(:,1)),length(t_1(1,:)),4);
%         score_list(:,:,1) = score_1;
%         score_list(:,:,2) = score_2;
%         score_list(:,:,3) = score_3;
%         score_list(:,:,4) = score_4;
%         score_list(:,:,5) = score_5;
%         score_list(:,:,6) = score_6;
%         score_list(:,:,7) = score_7;
%         score_list(:,:,8) = score_8;
%         
%         score_tmp = reshape(score_list(:,:,type_tmp),[length(t_1(:,1)),length(t_1(1,:))]);
% 
%         loca_plus = find(score_tmp > thres_noise);
