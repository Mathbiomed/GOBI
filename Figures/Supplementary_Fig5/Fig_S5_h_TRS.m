...
%% merge TRS of true and false regulations
score_total = [];
group_total = [];
for i = 1:5
    % load true network
    ...
    for noise_percent = noise_list
        ...
        for trial = trial_list
            ...
            % for each pair and type, compute TRS
            for j = 1:num_pair
                for k = 1:num_type
                    ...
                    thres_S = 0.9 - 0.005 * noise_percent;
                    ...
                    if idx_true(j,k) == 1
                        score_true = [score_true ; TRS_tmp];
                    else
                        score_false = [score_false ; TRS_tmp];
                    end
                end
            end
        end
...
set(gca,'XTick',[6.5:18:42.5],'XTickLabel',{' '})
hold on
plot([6.5,42.5],[0.9,0.7],'r')
