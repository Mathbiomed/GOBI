...
for trial = trial_list
    ...
    for noise_percent = noise_list
        ...
        for i = 1:length(y_total)
            ...
            cn = dsp.ColoredNoise('blue',length(t),num_component,OutputDataType='single');
            noise = cn();
        ...
        filename = ['./Data_blue/',system,'_timeseries_blue_',num2str(noise_percent),'_Trial',num2str(trial)];
