...
for trial = trial_list
    ...
    for noise_percent = noise_list
        ...
        for i = 1:length(y_total)
            ...
            cn = dsp.ColoredNoise('brown',length(t),num_component,OutputDataType='single');
            noise = cn();
        ...
        filename = ['./Data_brown/',system,'_timeseries_brown_',num2str(noise_percent),'_Trial',num2str(trial)];
