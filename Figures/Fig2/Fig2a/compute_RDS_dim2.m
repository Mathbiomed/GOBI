...
%% calculate score
S_total = zeros(length(component_list(:,1)),4,num_data);
L_total = zeros(length(component_list(:,1)),4,num_data);
...
parfor i = 1:num_data
    ...
    S_tmp = zeros(length(component_list(:,1)),4);
    L_tmp = zeros(length(component_list(:,1)),4);
